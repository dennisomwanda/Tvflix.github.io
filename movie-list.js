...
fetchDataFromServer(`https://api.themoviedb.org/3/discover/movie?api_key=${api_key}&include_adult=false&include_video=false&page=${currentPage}&sort_by=popularity.desc&${urlParam}`, function ({ results: movieList, total_pages }) {
  ...
  <button class="btn load-more" load-more>Load More</button>
    ...
    /**
     *  add movie card base on fetched item
     */
